...
@Component({
  selector: 'app-youtube-mock',
  templateUrl: './youtube-mock.component.html',
  styleUrls: ['./youtube-mock.component.scss']
})
export class YoutubeMockComponent implements OnInit {
  expanded: any;
